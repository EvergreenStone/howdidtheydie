export default async function AnalysisSubmissionReceivedPage({
  searchParams,
}: {
    ...
    <main className="min-h-screen bg-[#f4f1ea] text-[#1d2a2a]">
      <section className="mx-auto max-w-3xl px-6 py-24 text-center">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-[#586260]">
          {person
            ? `Your community analysis for ${person} was saved successfully.`
            : "Your community analysis was saved successfully."}{" "}
